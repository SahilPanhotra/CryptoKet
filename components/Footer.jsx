...
const FooterLinks = ({ heading, items }) => (
  <div className="flex-1 justify-start items-start "><h3 className="font-poppins dark:text-white text-nft-black-1 font-semibold text-xl mb-10">{heading}</h3>
    ...
    <footer className="flexCenter flex-col border-t dark:border-nft-black-1 border-nft-gray-1 sm:py-8 py-16">
      ...
      <div className="flexCenter w-full mt-5 border-t dark:border-nft-black-1 border-nft-gray1 sm:px-4 px-16">
        <div className="flexBetween flex-row w-full minmd:w-4/5 sm:flex-col mt-7">
          <p className="font-poppins dark:text-white text-nft-black-1 font-semibold text-base"> Cryptoket, Inc. All Rights Reserved.
          </p>
